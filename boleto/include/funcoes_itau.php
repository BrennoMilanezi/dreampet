...
$nnum = /*"1".*/formata_numero($dadosboleto["nosso_numero"],8,0);
...
function modulo_10($num) { 
	...
	// v?ias linhas removidas, vide fun?o original
...
function modulo_11($num, $base=9, $r=0)  {
     ...
     *
     *   Entrada:
     *     $num: string num?ica para a qual se deseja calcularo digito verificador;
     ...
     *
     *   Observa?es:
     *     - Script desenvolvido sem nenhum reaproveitamento de c?igo pr?existente.
     *     - Assume-se que a verifica?o do formato das vari?eis de entrada ?feita antes da execu?o deste script.
     */                                        
...
function geraCodigoBanco($numero) {
  ...
  function getImagemCodigoDeBarras($codigo)
    {
